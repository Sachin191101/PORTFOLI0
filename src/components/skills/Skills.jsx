          ...
          <div className="left flex-1 w-full">
            ...
            >
              <div className=" flex flex-col gap-6  w-3/4  my-5 md:w-[90%]">
                ...
                <ProgressBar logo={<FaPython />} name={"Python"}value={79} />
                <ProgressBar logo={<GrCode />} name={"C++"}value={95} />
                <ProgressBar logo={<GrCode />} name={"C"}value={85} />
                <ProgressBar logo={<GrCode />} name={"UI/UX"}value={95} />
                <ProgressBar logo={<GrCode />} name={"Machine Learning"}value={75} />
                <ProgressBar logo={<GrCode />} name={"DSA"}value={75} />
                <ProgressBar logo={<GrCode />} name={"SQL"}value={70} />
                <ProgressBar logo={<GrCode />} name={"Bootstrap"}value={85} />
                <ProgressBar logo={<GrCode />} name={"Node JS"}value={80} />
                <ProgressBar logo={<GrCode />} name={"Mongo DB"}value={95} />
                <ProgressBar logo={<GrCode />} name={"Express JS"}value={85} />
                <ProgressBar logo={<GrCode />} name={"Next JS"}value={80} />
